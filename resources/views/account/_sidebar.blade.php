<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ url('account/user-pages') }}" class="{{ set_active('account/user-pages*') }}">User Pages</a></div>
        <div class="sidebar-item"><a href="{{ url('account/deactivate') }}" class="{{ set_active('account/deactivate') }}">Deactivate</a></div>
    </li>
</ul>
