...
@if ($comment->deleted_at == null)
    ...
    <div class="media-body row mw-100 mx-0" style="flex:1;flex-wrap:wrap;">
        <div class="d-none d-md-block">
            <img class="mr-3 mt-2" src="{{ $comment->commenter->avatarUrl }}" style="width:70px; height:70px;" alt="{{ $comment->commenter->name }}'s Avatar">
        </div>
...
<div class="media-body row mw-100 mx-0" style="flex:1;flex-wrap:wrap;">
    <div class="d-none d-md-block">
        <img class="mr-3 mt-2" src="/images/avatars/default.jpg" style="width:70px; height:70px;" alt="Default Avatar">
    </div>
