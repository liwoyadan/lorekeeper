<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/links' }}" class="{{ set_active('character/' . $character->slug . '/links') }}">Relationships</a></div>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/relationship-logs' }}" class="{{ set_active('character/' . $character->slug . '/relationship-logs') }}">Relationship Logs</a></div>
    </li>
