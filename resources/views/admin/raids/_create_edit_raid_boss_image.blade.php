@if ($bossImage->id)
    ...
    {!! Form::open(['url' => 'admin/data/raid-bosses/' . $raidBoss->id . '/image/edit/' . $bossImage->id, 'files' => true]) !!}
    <div class="form-group">
        {!! Form::label('Change Boss Image') !!}
    ...
    <div class="alert alert-info">
        ...
        There are two types of thresholds: <b>percentage</b> indicates the health threshold number inputted should be a percentage of the boss's total health value (i.e. 25% of 1000 -> begin displaying at 250 HP), or a <b>specific amount</b> which is a static value (i.e. 555 HP out of 1000).<br><br>
...
@else
    ...
    {!! Form::open(['url' => 'admin/data/raid-bosses/' . $raidBoss->id . '/image/create', 'files' => true]) !!}
    <div class="form-group">
        {!! Form::label('Boss Image') !!} <b>(Required)</b>
        <div class="custom-file">
            {!! Form::label('image', 'Choose file...', ['class' => 'custom-file-label']) !!}
            {!! Form::file('image', ['class' => 'custom-file-input']) !!}
        </div>
