@if ($setting)
    ...
    <p>
        Users who have saved a value for this setting keep the value stored in their data in the DB, <i>however,</i> it will stop effecting the site's look and no longer appear in the accessibility panel. Recreating a setting on the same property
        will bring it back.
    </p>
    <p>
