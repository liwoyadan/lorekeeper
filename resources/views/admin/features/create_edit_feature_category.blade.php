...
@section('admin-content')
    ...
    {{ html()->form('POST', $category->id ? 'admin/data/trait-categories/edit/' . $category->id : 'admin/data/trait-categories/create')->acceptsFiles()->open() }}
    ...
    <div class="form-group">
        ...
        {{ html()->label('Is Visible', 'is_visible')->class('form-check-label ml-3') }} {!! add_help('If turned off, the category will not be visible in the category list or available for selection in search. Permissioned staff will still be able to add traits to them, however.') !!}
    </div>
